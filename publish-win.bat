...
7z a -tzip %BUILD_FOLDER%\RedBookPlayer-dbg_net8.0_win-x64.zip *
cd %BUILD_FOLDER%\RedBookPlayer.GUI\bin\Release\net8.0\win-x64\publish\
7z a -tzip %BUILD_FOLDER%\RedBookPlayer_net8.0_win-x64.zip *
cd %BUILD_FOLDER%\RedBookPlayer.GUI\bin\Debug\net8.0\linux-x64\publish\
7z a -tzip %BUILD_FOLDER%\RedBookPlayer-dbg_net8.0_linux-x64.zip *
cd %BUILD_FOLDER%\RedBookPlayer.GUI\bin\Release\net8.0\linux-x64\publish\
7z a -tzip %BUILD_FOLDER%\RedBookPlayer_net8.0_linux-x64.zip *